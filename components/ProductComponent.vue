  ...
  <div id="`ProductComponent${product.id}`" class="bg-white inline-block rounded hover:shadow-[0_0_10px_3px_rgba(0,0,0,0.15)] cursor-pointer">
   ...
   <div id="ProductDetails">
    <span class="flex items center justify-start gap-3 px-1 pt-1">
      ...
      <span class="text-gray-500 font-semibold text-sm line-through">{{priceComputed}}</span>
    </span>
     <span class="px-1 relative -top-1.5 text-[#ff6674] text-xs font-semi-bold">
      Extra 5% off
     </span>

     <div class="flex items-center gap-1 px-1 relative-top-1">
      <span class="bg-[#fd374f] text-white text-[9px] font-semibold px-1.5 ">Welcome Deal</span>
    ...
    <p class="px-1 pt-0 5text-xs text-[#252525]">
