     ...
     <div class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-4 mx-auto">
            ...
            <div class="max-w-[700px] w-full md:block hidden">
                <div class="relative">
                    <div class="flex items-center border-2 border-[#ff4646] rounded-md w-full">
                        <input type="text" name="" id="" class="w-full placeholder-gray-400 text-sm pl-3 focus:outline-none"
                        placeholder="Kitchen accesories" v-model="searchItem">
                        <Icon 
                        v-if="isSearching"
                        name="eos-icons:loading" size="25" class="mr-2"
                        />
                        <button class="flex items-center h-[100%] p-1.5 px-2 bg-[#ff4646]">
                           <Icon 
                       
                        name="ph:magnifying-glass" size="20" color="#ffffff"
                        /> 
                        </button>
                    </div>
                    <div class="absolute bg-white max-w-[700px] h-auto w-full">
                      <div v-if="false" class="p-1">
                            ...
                            <div class="flex items-center">
                                <img class="rounded-md" alt="" width="40" src="https://picsum.photos/id/82/300/300">
            ...
            class="flex items-center">
                ...
                @mouseleave="isCartHover = false">
                 <span class="absolute flex  items-enter justify-center -right-[3px] top-0 bg-[#ff4646] h-[17px] min-w-[17px] text-xs text-white px-0.5 rounded-full">0</span>
